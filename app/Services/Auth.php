...
// Load config from new location or fallback to old
...
if (!class_exists('Database')) {
    if (file_exists(dirname(__DIR__) . '/Models/Database.php')) {
        require_once dirname(__DIR__) . '/Models/Database.php';
    } elseif (file_exists(APP_ROOT . '/database.php')) {
...
if (!class_exists('Logger')) {
    ...
    } elseif (file_exists(APP_ROOT . '/Logger.php')) {
