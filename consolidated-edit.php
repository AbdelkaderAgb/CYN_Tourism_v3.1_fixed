    ...
    <form method="post" class="form">
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="time" name="pickup_time" value="<?php echo htmlspecialchars($data['pickup_time'] ?? '10:00'); ?>" required>
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="date" name="return_date" value="<?php echo htmlspecialchars($data['return_date'] ?? ''); ?>">
            </div>
            <div class="form-group">
                <label>Donus Saati</label>
                <input type="time" name="return_time" value="<?php echo htmlspecialchars($data['return_time'] ?? ''); ?>">
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="number" name="total_pax" value="<?php echo htmlspecialchars($data['total_pax'] ?? 1); ?>" min="1">
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="time" name="meeting_time" value="<?php echo htmlspecialchars($data['meeting_time'] ?? '09:00'); ?>" required>
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                <label>Tutar</label>
                <input type="number" name="total_amount" value="<?php echo htmlspecialchars($data['total_amount'] ?? 0); ?>" step="0.01">
            </div>
        </div>
