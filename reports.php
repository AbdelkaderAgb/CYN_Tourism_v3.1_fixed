...
// Revenue Report
$revenueReport = Database::getInstance()->fetchAll(
...
// Company Report
$companyReport = Database::getInstance()->fetchAll(
...
// Transfer Statistics
$transferStats = Database::getInstance()->fetchOne(
...
// Currency Summary
$currencySummary = Database::getInstance()->fetchAll(
...
$monthlyRevenue = Database::getInstance()->fetchAll(
...
$transferTypes = Database::getInstance()->fetchAll(
...
// Partner performance
$partnerPerformance = Database::getInstance()->fetchAll(
