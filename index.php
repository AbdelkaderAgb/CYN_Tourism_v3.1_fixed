...
$isApiRequest = $isApiRequest || isset($_GET['api']) || (isset($_SERVER['REQUEST_URI']) && strpos($_SERVER['REQUEST_URI'], '/api/') !== false);
...
if ($isApiRequest) {
    ...
    function authenticateApi() {
        ...
        $validKey = Database::getInstance()->fetchOne(
    ...
    switch ($endpoint) {
        ...
        case 'login':
            ...
            if ($user && password_verify($password, $user['password'])) {
                ...
                $apiKey = Database::getInstance()->fetchOne(
    ...
    // Web Mode - redirect to appropriate page
    if (Auth::check()) {
